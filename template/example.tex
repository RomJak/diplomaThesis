...
\newcommand{\thesistitle}{A Usability Design Approach of Tailored
...
\setdate{01}{09}{2018} % Set date with 3 arguments: {day}{month}{year}.
\settitle{\thesistitle}{A Usability Design Approach of Tailored
...
\input{paperprototypes.tex}

% CHAPTER Evaluation
\input{evaluation.tex}

% CHAPTER Evaluation
%\input{cataloge_guidelines.tex}

% CHAPTER Critical reflection
\input{critical_reflection.tex}
...
\begin{appendices}
	...
	\includegraphics[width=\linewidth]{survey2.pdf}
\end{appendices}
\end{document}